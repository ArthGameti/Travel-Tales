...
// Home page component with dark theme and responsive design
const Home = () => {
  ...
  // Initialize modal and fetch user info and stories on mount
  useEffect(() => {
  ...
  const handleSearch = (searchResults) => {
    if (searchResults.length === 0) {
      getAllTravelStories(); // Reset to all stories if search is empty or fails
    } else {
